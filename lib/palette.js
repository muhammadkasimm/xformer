...
exports.getUsedMemory = exports.defaultAll = exports.sumAll = exports.differential = exports.mergeWithAdd = exports.pickByRegex = exports.pickFrom = undefined;
...
const defaultAll = exports.defaultAll = R.curry((value, data) => {
  R.cond([[_.typeMatches('array'), R.map(_.defaultTo(value))], [_.typeMatches('object'), R.map(_.defaultTo(value))], [_.typeMatches('number'), _.defaultTo(value)], [_.typeMatches('string'), _.defaultTo(value)], [R.T, _.defaultTo(value)]])(data);
});
 ...
 * @returns {number}
 */
const getUsedMemory = exports.getUsedMemory = R.cond([[_.typeMatches('array'), R.map(_.getUsedMemoryForSingle)], [_.typeMatches('object'), R.map(_.getUsedMemoryForSingle)], [_.typeMatches('number'), _.getUsedMemoryForSingle], [_.typeMatches('string'), _.getUsedMemoryForSingle], [R.T, _.getUsedMemoryForSingle]]);