...
function executeAction(fn, data) {
  return R.cond([[_.typeMatches('function'), func => func.call(this, data)], [_.typeMatches('array'), R.map(func => func.call(this, data))]])(fn);
}
...
function executePipe(pipe, data) {
  return R.pipe(D.decodePipe.bind(this), _.reduceIndexed((acc, fn, idx) => {
