...
exports.pickFrom = exports.pickProp = exports.getAverageForList = exports.getUsedMemoryForSingle = exports.isSomething = exports.isNothing = exports.logger = exports.getFirstMatch = exports.reduceIndexed = exports.mapIndexed = exports.zipValueWithStep = exports.sumList = exports.keepLatest = exports.min = exports.max = exports.divide = exports.multiply = exports.subtract = exports.add = exports.typeMatches = exports.bePositive = exports.defaultToZero = exports.defaultTo = exports.isJunk = undefined;
 ...
 * @returns {number}
 */
const add = exports.add = R.curry((l, r) => R.add(defaultToZero(l), defaultToZero(r)));
 ...
 * @returns {number}
 */
const subtract = exports.subtract = R.curry((l, r) => R.subtract(defaultToZero(l), defaultToZero(r)));
 ...
 * @returns {number}
 */
const multiply = exports.multiply = R.curry((l, r) => R.multiply(defaultToZero(l), defaultToZero(r)));
 ...
 * @returns {number}
 */
const divide = exports.divide = R.curry((l, r) => R.divide(defaultToZero(l), defaultTo(1, r)));
 ...
 * @returns {number}
 */
const max = exports.max = R.curry((l, r) => R.max(defaultToZero(l), defaultToZero(r)));
 ...
 * @returns {number}
 */
const min = exports.min = R.curry((l, r) => R.min(defaultToZero(l), defaultToZero(r)));
 ...
 * @returns {number}
 */
const keepLatest = exports.keepLatest = R.curry((l, r) => defaultToZero(r));

/**
 * @param  {Array<number>} data
 * @returns {number}
 */
const sumList = exports.sumList = R.reduce(add, 0);
 ...
 * @returns {boolean}
 */
const getAverageForList = exports.getAverageForList = R.pipe(R.reject(isJunk), R.converge(divide, [R.sum, R.length]), defaultToZero);
 ...
 * @returns {any}
 */
const pickProp = exports.pickProp = R.curry((prop, isPrevWildcard, data) => {
 ...
 * @returns  {any}
 */
const pickFrom = exports.pickFrom = R.curry(_pickFrom)(0);