...
function evaluate(str) {
  return R.pipe(R.tryCatch(eval, R.always(str)), R.when(R.test(/^[\$.]/), R.pipe(R.split('.'), R.path(R.__, this))))(str);
}
...
function decodePipe(pipe) {
  return R.map(R.cond([[_.typeMatches('string'), decodeStringyAction.bind(this)], [_.typeMatches('object'), decodeObjectAction.bind(this)], [_.typeMatches('array'), decodePipe.bind(this)]]), pipe);
}
