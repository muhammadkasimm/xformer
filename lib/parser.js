 ...
 */
const translateObjectToString = R.converge(R.concat, [R.prop('name'), R.ifElse(R.propSatisfies(_.isSomething, 'params'), R.pipe(R.prop('params'), R.map(R.toString), R.join(', '), x => `(${x})`), R.always(''))]);
